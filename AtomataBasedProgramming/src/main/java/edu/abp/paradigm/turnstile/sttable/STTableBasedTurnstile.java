 ...
 *
 */
public class STTableBasedTurnstile extends AbstractTurnstile<TurnstileState> {
	...
	public STTableBasedTurnstile(TurnstileController controller) {
		...
		transitions.put(new StateEvent<>(TurnstileState.LOCKED, TurnstileEvent.PASS),
				new Transition(TurnstileState.LOCKED, new Action() {
