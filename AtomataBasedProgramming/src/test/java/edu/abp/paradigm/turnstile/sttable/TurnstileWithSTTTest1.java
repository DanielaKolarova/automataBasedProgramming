...
import edu.abp.paradigm.turnstile.sttable.STTableBasedTurnstile1;
 ...
 *
 */
public class TurnstileWithSTTTest1 extends AbstractTurnstileTest {
	...
	protected Turnstile createTurnstile(TurnstileController controller) {
		return new STTableBasedTurnstile1(controller);
	}
